...
\begin{figure}[h!]
\centering
\includegraphics[width=0.35\textwidth]{pitch_metaflow.png}
\hfill
\includegraphics[width=0.55\textwidth]{starthack_win.jpg}
\caption*{\small\color{mfgray} Left: Metaflow UI showing the procurement pipeline DAG. Right: StartHack 2026 winning ceremony.}
\end{figure}
