...
\vfill
{\small\color{mfgray} \href{https://drive.google.com/file/d/1kOcsjZq4CIPGR2IsXiEggBKzrgb08ME4/view?usp=sharing}{Presentation (Google Drive)}, demo video, benchmark code, and documentation attached.}
\end{center}
\end{titlepage}
